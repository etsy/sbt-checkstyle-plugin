...
Checkstyle.CheckstyleTasks.checkstyleConfig := Checkstyle.CheckstyleConfig.File("my-checkstyle-config.xml")
Checkstyle.checkstyleSettings ++ Seq(
  Checkstyle.CheckstyleTasks.checkstyleConfig := Checkstyle.CheckstyleConfig.File("test-checkstyle-config.xml"),
