...
Checkstyle.CheckstyleTasks.checkstyleConfig := Checkstyle.ConfigSource.File("my-checkstyle-config.xml")
Checkstyle.checkstyleSettings ++ Seq(
  Checkstyle.CheckstyleTasks.checkstyleConfig := Checkstyle.ConfigSource.File("test-checkstyle-config.xml"),
